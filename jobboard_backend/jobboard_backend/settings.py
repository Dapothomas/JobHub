...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'jobapp.serializers.CustomUserCreateSerializer',
        'user': 'jobapp.serializers.CustomUserSerializer',
        'current_user': 'jobapp.serializers.CustomUserSerializer',
    },
}

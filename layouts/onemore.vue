<template>
    <div>
        <nav id="navbar" class="p-6 flex items-center justify-between bg-white dark:bg-gray-900 backdrop-filter dark:backdrop-blur-lg dark:backdrop-opacity-40 fixed top-0 left-0 w-full z-50 transition duration-1000">
...
export default {
  methods: {
      toggleDarkMode(event) {
        this.$colorMode.preference = event.target.checked ? 'dark' : 'light';
      },
    },
  mounted() {
